      ...
      <section>
        ...
        <Card className="flex-col !flex">
          ...
          <div className="btn-row">
            ...
            <Button variant="icon"><span className="material-icons" style={{ fontSize: 18 }}>settings</span></Button>
          </div>
          ...
          <div className="btn-row">
            ...
            <Button variant="dark">Get Started <span className="material-icons ml-1" style={{ fontSize: 18 }}>arrow_forward</span></Button>
          </div>
        </Card>
      </section>
          ...
          <div className="card-grid card-grid-2 gap-5">
            <div className="flex-col !flex">
              ...
              <div className="form-group">
                ...
                <Input placeholder="alex@veramind.com" icon={<span className="material-icons" style={{ fontSize: 18 }}>mail</span>} />
              </div>
              <div className="form-group">
                <label className="form-label">Confirm Password</label>
                <Input type="password" value="••••••" readOnly error />
                <span className="form-error flex items-center gap-1"><span className="material-icons" style={{ fontSize: 14 }}>close</span> Passwords do not match</span>
              </div>
            </div>
            <div className="flex-col !flex">
              <div className="form-group">
      ...
      <section>
        ...
        <div className="card-grid card-grid-2">
          <div className="flex flex-col gap-3">
            <Alert variant="info" icon={<span className="material-icons">info</span>} title="Session starting soon">Your scheduled guided meditation begins in 5 minutes.</Alert>
            <Alert variant="success" icon={<span className="material-icons">check_circle</span>} title="Streak achieved!">Congratulations on your 7-day mindfulness streak. Keep it up!</Alert>
            <Alert variant="warning" icon={<span className="material-icons">warning</span>} title="High stress detected">Your biometric data suggests elevated stress.</Alert>
          </div>
